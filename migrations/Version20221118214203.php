 ...
 */
final class Version20221118214203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat_event (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', sender VARCHAR(255) NOT NULL, INDEX IDX_3AD3E73C71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE chat_event ADD CONSTRAINT FK_3AD3E73C71F7E88B FOREIGN KEY (event_id) REFERENCES events (id)');
